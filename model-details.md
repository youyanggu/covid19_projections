...
We are able to generate confidence intervals for each region based on the projections generated by each set of parameters, exponentially weighted by their loss. As a result, more accurate parameter sets in-sample receive a higher weight. We then sort the projections generated from these parameter sets and apply a percentile to the projections to create our confidence intervals for each day. This method has roots in Bayneisan inference.
