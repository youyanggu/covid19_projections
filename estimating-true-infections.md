...
One thing to note is that original definition of the herd immunity threshold is derived from the basic reproduction number, R0, and assumes no intervention and no social distancing. Hence, by definition, the HIT of the SARS-CoV-2 virus remains unchanged over time, between 50-80%. But the effective HIT does change over time as the effective reproduction number, Rt, decreases due to society adjusting to the virus. That's why we are seeing an effective HIT of 10-35%. A removal of current restrictions and interventions may cause the effective HIT to return to its original levels of 50-80%.
