...
Since June 1, 2020, we use a variable IFR that decreases over time to reflect improving treatments and the lower proportion of care home deaths. Hence, we decrease the initial IFR linearly over the span of 3 months until it is 40% of the original IFR. So for example, by August 2020, we estimate the IFR to be ~0.4% in the US and ~0.3% in most of Western Europe.
