...
* **January 12:** We added vaccination plots to the infections page for every US state (and nationally) based on the latest [CDC data](https://covid.cdc.gov/covid-data-tracker/#vaccinations). For example, see the vaccination progress for the [US](/infections/us). See maps of the vaccination progress [here](/maps-infections).
